...
root = Tk()
root.title("CELCI")
root.iconphoto(False, ImageTk.PhotoImage(file="C:\\Users\\Madina\\Desktop\\Icon.png"))
root.geometry("900x600")
root.minsize(900,600)
root.resizable(width = True, height = True)

image=cv2.imread("C:\\Users\\Madina\\Desktop\\p3.png",0)
...
def page2():
    ...
    pag.iconphoto(True, ImageTk.PhotoImage(file="C:\\Users\\Madina\\Desktop\\Icon.png"))
...
def page3():
    ...
    pag1.iconphoto(False, ImageTk.PhotoImage(file="C:\\Users\\Madina\\Desktop\\Icon.png"))
...
# f2.pack(side=TOP,fill="x")
photo=ImageTk.PhotoImage(Image.open("C:\\Users\\Madina\\Desktop\\logo.png").resize((100, 100), Image.ANTIALIAS))
m = Label(f1, image=photo)
m.pack(pady=40)
